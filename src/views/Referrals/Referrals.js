...
async function getReferralCodeTakenStatus(account, referralCode, chainId) {
  ...
  const codeOwner = await getReferralCodeOwner(KAVA, referralCodeBytes32);

  const takenOnKava =
    !isAddressZero(codeOwner) && (codeOwner !== account || (codeOwner === account && chainId === KAVA));
  if (takenOnKava) {
      ...
      <div className="default-container page-layout Referrals">
        <div className="ref-layout">
          {needHelp && ( //instruction section start
            <div className="instructions-container">
              <div className="instruction-container">
                ...
                <div className="instruction-container--icon">
                  <img
                    width={74}
                    height={74}
                    src={'https://res.cloudinary.com/kinetix/image/upload/v1693210875/website-assets/referrals/illustration-icon1.svg'}
                    // src={getImageUrl({
              ...
              <div className="instruction-container">
                <div className="instruction-container--header">
                  <span>02</span>
                  <p>Enter your own unique code (Combination of Letters, Numbers or underscores) e.g. Kfi_10</p>
                </div>
                <div className="instruction-container--icon">
                  <img
                    width={74}
                    height={74}
                    src="https://res.cloudinary.com/kinetix/image/upload/v1693210875/website-assets/referrals/illustration-icon2.svg"
                    // src={getImageUrl({
          ...
          <div className="refs-container">
            ...
            <a
              className="ref-link"
              href="https://info.kinetix.finance/our-referral-program"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              className="ref-link"
              href="https://stats.kinetix.finance/#/referrals"
              target="_blank"
              rel="noreferrer"
            >
                      ...
                      <td data-label="Referral Code">
                        <div className="table-referral-code">
                          <div
                            onClick={() => {
                              copyToClipboard(
                                `https://perps.kinetix.finance/#/?${REFERRAL_CODE_QUERY_PARAMS}=${stat.referralCode}`
                              );
                          ...
                          {codeOwner && codeOwner?.isTaken && !codeOwner?.isTakenByCurrentUser && (
                            <div className="info">
                              <Tooltip
                                ...
                                renderContent={() => (
                                  <div>
                                    This code has been taken by someone else on KAVA, you will not receive
