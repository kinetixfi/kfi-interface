...
export default function BeginAccountTransfer(props) {
  ...
  const feeGllTrackerAddress = getContract(chainId, "FeeKlpTracker");
      ...
      <div className="BeginAccountTransfer-container">
        <div className="Page-title-section">
          ...
          <div className="Page-description">
            ...
            <br />
            This will transfer all your KLP tokens to your new account.
            <br />
            Transfers are only supported if the receiving account has not  KLP tokens before.
            <br />
        ...
        <div style={{ padding: "24px 0 0 0" }} className="Page-content">
          <div className="input-form">
            ...
            <div className="BeginAccountTransfer-validations">
              <ValidationRow isValid={!hasStakedKlp}>Receiver has not staked KLP tokens before</ValidationRow>
            </div>
            <div className="input-row">
              <button
