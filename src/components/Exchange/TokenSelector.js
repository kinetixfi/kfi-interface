      ...
      >
        <div className="TokenSelector-tokens">
          ...
          {filteredTokens.map((token, tokenIndex) => {
            ...
            if (showMintingCap && mintingCap && info.usdkAmount) {
              mintAmount = mintingCap.sub(info.usdkAmount);
            }
              ...
              >
                ...
                <div className="Token-balance">
                  ...
                  {/* <span className="text-accent">
                    {mintAmount && <div>Mintable: {formatAmount(mintAmount, token.decimals, 2, true)} USDK</div>}
