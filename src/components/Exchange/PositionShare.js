...
function PositionShare({ setIsPositionShareModalOpen, isPositionShareModalOpen, positionToShare, account, chainId }) {
  ...
  const tweetLink = getTwitterIntentURL(
    `Latest $${positionToShare?.indexToken?.symbol} trade on @KinetixFi`,
            ...
            <div className="position-share-price-ref">
              ...
              <div className="position-share-ref">
                {success&&code ? (
                  ...
                  <p style={{ margin: 0,fontSize: 8, fontWeight: 300, maxWidth:"80px",maxHeight:"36px", wordWrap:"break-word",overflow:"hidden" }} className="">https://perps.kinetix.finance</p>
                )}
              </div>
            </div>
          </div>
